...
- Integracao principal alinhada ao contrato usado pelo projeto, com adaptacoes operacionais aplicadas ate a linha util da `API V6.1` e revisoes de impacto feitas contra as APIs `V6.3`, `V6.5`, `V6.6` e `V6.7`.
...
- Analise de impacto da `API V6.7` documentada em `GUARITA_POS_API_V6_7_2026-04-27.md`.
